...
from src.utils.adaptive_schema import ExecRole, SchemaColumn, SchemaProfile
...
class QueryFeatureExtractor:
    ...
    def extract_features(self, query: str, metadata: Dict[str, Any]) -> Dict[str, float]:
        ...
        if rewrite_count > 0:
            ...
            rewrite_conf_sum = sum(rewrite.get("confidence", 0.0) for rewrite in metadata.get("rewrites", []))
...
class MLPrecisionModel:
    ...
    def __init__(self, vectorizer: Optional[FeatureVectorizer] = None, model=None):
...
class PrecisionScoringEngine:
    ...
    def predict_precision(self, query: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            ...
            "features": features,
            "threshold": {"high": 0.7, "medium": 0.4, "low": 0.0},
        }
...
def test_precision_scoring():
    ...
    from src.utils.adaptive_schema import SchemaColumn, SchemaProfile
    ...
    test_cases = [
        ...
        },
        {
            ...
            "metadata": {
                "column_matches": {"sell": [{"column": "units_sold", "confidence": 0.7}]},
