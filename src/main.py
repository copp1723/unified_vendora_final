...
if __name__ == '__main__':
    ...
    app_config = {
        ...
        'DATA_STORAGE_PATH': os.getenv('DATA_STORAGE_PATH', './data'), # Default to local ./data
        'MEMORY_STORAGE_PATH': os.getenv('MEMORY_STORAGE_PATH', './memory') # Default to local ./memory
    }
    ...
    logger.info(f"🌐 Access at: http://localhost:{os.getenv('PORT', 5001)}") # Use PORT from env if available for flexibility
